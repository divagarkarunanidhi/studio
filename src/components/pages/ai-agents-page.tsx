            ...
            <body>
                <div class="container">
                    ...
                    <div class="summary">
                        ...
                        <ul>
                            <li><span>Status:</span> <span class="status-pass">PASSED</span></li>
                    ...
                    <hr/>
                    <p style="text-align:center; font-size: 12px; color: #999;">End of automated report generated by TaaS AI Engine</p>
                </div>
            </body>
            </html>
        `;
