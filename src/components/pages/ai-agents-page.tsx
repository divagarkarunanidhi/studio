...
export function AIAgentsPage() {
    ...
    const handleDownloadReport = (fileName: string) => {
        const mockHtml = `
            <!DOCTYPE html>
            <html>
            <head><title>Cucumber Report - ${fileName}</title></head>
            <body style="font-family: sans-serif; padding: 40px;">
                <h1 style="color: #d40511;">Cucumber Execution Report</h1>
                ...
                <div style="background: #f4f4f4; padding: 20px; border-radius: 8px;">
                    <p>This is a simulated Cucumber HTML report fetched from Confluence.</p>
                </div>
            </body>
            </html>
        `;
